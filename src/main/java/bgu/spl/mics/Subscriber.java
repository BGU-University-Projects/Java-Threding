...
public abstract class Subscriber extends RunnableSubPub {
    ...
    private static MessageBroker massagebrokerfield;
    /**
    ...
    public Subscriber(String name) {
        ...
        massagebrokerfield=MessageBrokerImpl.getInstance();
    }
    /**
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        massagebrokerfield.subscribeEvent(type,this);
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        massagebrokerfield.subscribeBroadcast(type,this);
        callbacks.put(type,callback);    }
    /**
    ...
    protected final <T> void complete(Event<T> e, T result) {
        massagebrokerfield.complete(e,result);
    }
    /**
    ...
    protected final void terminate() {
        ...
        massagebrokerfield.unregister(this);
    }
    /**
    ...
    public final void run() {
        massagebrokerfield.register(this);
        initialize();
        while (!terminated) {
            try {
                Message message=massagebrokerfield.awaitMessage(this);
